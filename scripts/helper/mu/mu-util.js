(function(global) {
    ...
    mu.util = {
         ...
         * @example mu.util.setCss($('#t1'),'tranform', 'rotate(45deg)');
         */
        ...
        /**
         * 阻止页面滚动
         * @example mu.util.preventScroll();
         */
        preventScroll: function() {
            document.addEventListener('touchmove', mu.util._preventDefault, false);
        },
        /**
         * 回复页面滚动
         * @example mu.util.recoverScroll();
         */
        recoverScroll: function() {
            document.removeEventListener('touchmove', mu.util._preventDefault, false);
        },
        ...
        isNumber: function(o){
            return mu.util.getType(o) === 'number';
        },
        /**
         * 深copy
        ...
        copy: function(obj) {
            ...
            for (var key in obj) {
                var _type = mu.util.getType(obj[key]);
                o[key] = _type === 'object' || _type === 'array' ? mu.util.copy(obj[key]) : obj[key];
            }
            return o;
        },
        /**
    ...
    if (global.doT) {
        var doT = global.doT;
        mu.util.dotHtml = function(tmplid, data) {
